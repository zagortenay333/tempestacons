...
* The script will ask for an icon size (single number). If you skip it, the icons default dimensions will be used.

* The script will ask for an icon color. If you skip it, the default color will be used.
